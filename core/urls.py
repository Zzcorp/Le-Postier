...
urlpatterns = [
    ...
    path('api/connection/<int:connection_id>/favorite/', views.toggle_connection_favorite,
         name='toggle_connection_favorite'),
    ...
    path('api/profile/cover/', views.update_cover_image, name='update_cover_image'),
